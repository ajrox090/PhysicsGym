...
env = KuramotoSivashinskyPhysicsGym(domain=domain, dx=dx, domain_dict=domain_dict,
                                    dt=0.01, step_count=step_count, dxdt=5)
env.reset()
...
# #                       learn=True, save_model="ddpgAgent_ks")
# ddpg_state = run_ddpg(load_model="ddpgAgent_ks", N=N)
ddpg_state = run_ddpg(N=N, learn=True, save_model="ddpgAgent_ks")
# print("random agent")

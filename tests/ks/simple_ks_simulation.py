...
#
# N = 8
# u = CenteredGrid(lambda x: math.sin(x)**2, x=N, extrapolation=extrapolation.PERIODIC, bounds=Box(x=100))
# physics = KuramotoSivashinsky()
#
# for _ in view('u', play=True, framerate=10, namespace=globals()).range():
#     u = physics.step(u, dt=1.0)
...
a = CenteredGrid(Noise(), xs=48, b=6, bounds=Box(xs=100, b=6))

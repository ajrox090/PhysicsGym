...
class BurgersEnvGymTestCases(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.viscosity = 0.01 / (cls.N * np.pi)
        cls.diffusion_substeps = 1
        cls.final_reward_factor = 32
        cls.reward_rms: Optional[RunningMeanStd] = None
        cls.exp_name = 'v0'
        cls.data_path = 'forced-burgers-clash'
    ...
    def test_init_env(self):
        env = BurgersEnvGym(N=self.N,
                            num_envs=self.num_envs,
                            domain=self.domain, dt=self.dt, viscosity=self.viscosity,
